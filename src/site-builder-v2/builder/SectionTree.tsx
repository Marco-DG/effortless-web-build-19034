...
import { Eye, EyeOff, Trash2, Plus, Layout, Grid, Type, Image, List, Phone, Star, Award, Calendar, ChevronDown, FileText, Copy, Edit2 } from 'lucide-react';
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="relative z-20">
                <SidebarItem
                    customIcon={
                        <span className="text-[10px] font-bold text-slate-500 font-geist">
                            {activeProject.pages.indexOf(activePage) + 1}/{activeProject.pages.length}
                        </span>
                    }
