...
import { SiteConfig, SectionConfig, PageConfig } from '../builder/types';
import { HeroSchema } from '../components/Hero';
import { GridSchema } from '../components/Grid';
...
import { GallerySchema } from '../components/Gallery';
import { ContentSchema } from '../components/Content';
import { FeaturesSchema } from '../components/Features';
import { TestimonialsSchema } from '../components/Testimonials';
import { AwardsSchema } from '../components/Awards';

import { ReservationSchema } from '../components/Reservation';
import { getAllSchemas } from '../builder/registry';
